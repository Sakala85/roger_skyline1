...
sudo adduser --disabled-password --gecos "" hoang
echo "hoang:test1234" | chpasswd
sudo adduser hoang sudo
...
sudo mkdir /home/gmolin/.ssh/
sudo mkdir /home/gmolin/.ssh/
cat ~/roger/deploy_automation/assets/ssh/id_rsa.pub > /home/hoang/.ssh/authorized_keys
